...
If readability issues need fixing, load `code-simplification` after review — not during the initial pass.
...
- For readability simplification after review findings, see `code-simplification`
