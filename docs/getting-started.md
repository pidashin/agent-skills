...
6. **Build (`source-grounded-development`, `incremental-implementation`, `test-driven-development`)** — Verify APIs in official docs, implement in thin slices, and prove behavior with tests.
